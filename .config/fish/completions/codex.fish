...
complete -c codex -n "__fish_codex_needs_command" -l local-provider -d 'Specify which local provider to use (lmstudio, ollama, or ollama-chat). If not specified with --oss, will use config default or show selection' -r
...
complete -c codex -n "__fish_codex_using_subcommand exec; and not __fish_seen_subcommand_from resume review help" -l local-provider -d 'Specify which local provider to use (lmstudio, ollama, or ollama-chat). If not specified with --oss, will use config default or show selection' -r
...
complete -c codex -n "__fish_codex_using_subcommand e; and not __fish_seen_subcommand_from resume review help" -l local-provider -d 'Specify which local provider to use (lmstudio, ollama, or ollama-chat). If not specified with --oss, will use config default or show selection' -r
...
complete -c codex -n "__fish_codex_using_subcommand resume" -l local-provider -d 'Specify which local provider to use (lmstudio, ollama, or ollama-chat). If not specified with --oss, will use config default or show selection' -r
...
complete -c codex -n "__fish_codex_using_subcommand fork" -l local-provider -d 'Specify which local provider to use (lmstudio, ollama, or ollama-chat). If not specified with --oss, will use config default or show selection' -r
...
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp mcp-server app-server completion sandbox execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds features help" -f -a "exec" -d 'Run Codex non-interactively'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp mcp-server app-server completion sandbox execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds features help" -f -a "review" -d 'Run a code review non-interactively'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp mcp-server app-server completion sandbox execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds features help" -f -a "login" -d 'Manage login'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp mcp-server app-server completion sandbox execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds features help" -f -a "logout" -d 'Remove stored authentication credentials'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp mcp-server app-server completion sandbox execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds features help" -f -a "mcp" -d '[experimental] Run Codex as an MCP server and manage MCP servers'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp mcp-server app-server completion sandbox execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds features help" -f -a "mcp-server" -d '[experimental] Run the Codex MCP server (stdio transport)'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp mcp-server app-server completion sandbox execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds features help" -f -a "app-server" -d '[experimental] Run the app server or related tooling'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp mcp-server app-server completion sandbox execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds features help" -f -a "completion" -d 'Generate shell completion scripts'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp mcp-server app-server completion sandbox execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds features help" -f -a "sandbox" -d 'Run commands within a Codex-provided sandbox'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp mcp-server app-server completion sandbox execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds features help" -f -a "execpolicy" -d 'Execpolicy tooling'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp mcp-server app-server completion sandbox execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds features help" -f -a "apply" -d 'Apply the latest diff produced by Codex agent as a `git apply` to your local working tree'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp mcp-server app-server completion sandbox execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds features help" -f -a "resume" -d 'Resume a previous interactive session (picker by default; use --last to continue the most recent)'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp mcp-server app-server completion sandbox execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds features help" -f -a "fork" -d 'Fork a previous interactive session (picker by default; use --last to fork the most recent)'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp mcp-server app-server completion sandbox execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds features help" -f -a "cloud" -d '[EXPERIMENTAL] Browse tasks from Codex Cloud and apply changes locally'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp mcp-server app-server completion sandbox execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds features help" -f -a "responses-api-proxy" -d 'Internal: run the responses API proxy'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp mcp-server app-server completion sandbox execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds features help" -f -a "stdio-to-uds" -d 'Internal: relay stdio to a Unix domain socket'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp mcp-server app-server completion sandbox execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds features help" -f -a "features" -d 'Inspect feature flags'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec review login logout mcp mcp-server app-server completion sandbox execpolicy apply resume fork cloud responses-api-proxy stdio-to-uds features help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
