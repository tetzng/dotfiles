...
complete -c codex -n "__fish_codex_using_subcommand execpolicy; and __fish_seen_subcommand_from check" -s p -l policy -d 'Paths to execpolicy files to evaluate (repeatable)' -r -F
